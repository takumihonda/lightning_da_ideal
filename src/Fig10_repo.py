...
#    _, ez, efp, evar = read_evars( INFO, tlev=tlev, vname=vname, member=member )
...
#           eglm1 = get_eGLM( efp1, kernel )
#           var1d_glm1 = eglm1[:,cy,cx]
#           ecor_glm1 = get_ecor( var1d_glm1, evar )
#       
#           eglm2 = get_eGLM( efp2, kernel )
#           var1d_glm2 = eglm2[:,cy,cx]
#           ecor_glm2 = get_ecor( var1d_glm2, evar )
#       
#           eglm3 = get_eGLM( efp3, kernel )
#           var1d_glm3 = eglm3[:,cy,cx]
#           ecor_glm3 = get_ecor( var1d_glm3, evar )
...
#                      ]
           ...
           tit_l = [ 
                     "{0:}-min GLM".format( (ac1 + 1)*5 ), 
                     "{0:}-min GLM".format( (ac2 + 1)*5 ), 
                     "{0:}-min GLM".format( (ac3 + 1)*5 ), 
                     "", "", "", "", "", "",
                     "", "", "", "", "", "",
                   ]
           unit_l = [ 
...
#
#              np.savez( fn, data=VAR_l[idx][jmin::nskip,imin::nskip],
#                        cdata=cvar )
